...
int main() {
    ...
    YoloConfig cfg;
    cfg.desc        = "coco pose task using yolov26n(model from ultralytics/ultralytics repo), using ONNXRuntime(CPU) runtime.";
    cfg.version     = YoloVersion::YOLO26;
    cfg.task        = YoloTaskType::POSE;
    cfg.target_rt   = YoloTargetRT::ORT_CPU;   // choose onnxruntime
    cfg.model_path  = "./vp_data/models/ultralytics/yolo26n-pose.onnx";
    cfg.input_w     = 640;
    cfg.input_h     = 640;
    cfg.batch_size  = 1;
    cfg.num_classes = 1;
