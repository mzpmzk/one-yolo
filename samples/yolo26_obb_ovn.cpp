...
int main() {
    ...
    YoloConfig cfg;
    cfg.desc        = "dotav1 obb task using yolov26n(model from ultralytics/ultralytics repo), using OpenVINO(AUTO) runtime.";
    cfg.version     = YoloVersion::YOLO26;
    cfg.task        = YoloTaskType::OBB;
    cfg.target_rt   = YoloTargetRT::OVN_AUTO;
    cfg.model_path  = "./vp_data/models/ultralytics/yolo26n-obb.onnx";
    cfg.input_w     = 1024;
    cfg.input_h     = 1024;
    cfg.batch_size  = 1;
    cfg.num_classes = 15;
