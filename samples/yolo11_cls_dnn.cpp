...
int main() {
    ...
    YoloConfig cfg;
    cfg.desc        = "imagenet classification task using yolov11n(model from ultralytics/ultralytics repo), using default(OpenCV::DNN/CPU) runtime.";
    cfg.version     = YoloVersion::YOLO11;
    cfg.task        = YoloTaskType::CLS;
    cfg.target_rt   = YoloTargetRT::OPENCV_CPU;
