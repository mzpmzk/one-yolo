...
int main() {
    ...
    YoloConfig cfg;
    cfg.desc        = "coco detection task using yolov11n(model from ultralytics/ultralytics repo), using TensorRT runtime.";
    cfg.version     = YoloVersion::YOLO11;
    cfg.task        = YoloTaskType::DET;
    cfg.target_rt   = YoloTargetRT::TRT;
    cfg.model_path  = "./vp_data/models/trt/others/yolo11n.engine";
    cfg.input_w     = 640;
    cfg.input_h     = 640;
    cfg.batch_size  = 1;
    cfg.num_classes = 80;
