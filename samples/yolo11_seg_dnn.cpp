...
int main() {
    ...
    YoloConfig cfg;
    cfg.desc        = "coco segmentation task using yolov11n(model from ultralytics/ultralytics repo), get structured results separately, using default(OpenCV::DNN/CUDA) runtime.";
